using IxnayServer.Domain.Events;
using Microsoft.Extensions.Logging;

namespace IxnayServer.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("IxnayServer Domain Event: {DomainEvent}", notification.GetType().Name);
